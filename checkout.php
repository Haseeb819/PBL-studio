...
session_start();
 if(!isset($_SESSION['stuLogEmail'])) {
  ...
  <div class="container mt-5">
    ...
    <h3 class="mb-5">Welcome to PBL studio Payment Page</h3>
     <form method="post" action="./Payments/pgRedirect.php">
      ...
      <div class="text-center">
       <input value="Order" type="submit"	class="btn btn-primary" onclick="">
